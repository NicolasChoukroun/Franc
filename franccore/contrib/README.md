...
Additional tools, including the `github-merge.py` script, are available in the [maintainer-tools](https://github.com/franc-core/franc-maintainer-tools) repository.
...
Files used during the gitian build process. For more information about gitian, see the [the Franc documentation repository](https://github.com/franc-core/docs).

### [Gitian-keys](/contrib/gitian-keys)
PGP keys used for signing Franc [Gitian release](/doc/release-process.md) results.

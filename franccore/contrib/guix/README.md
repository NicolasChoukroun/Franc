# Bootstrappable Franc Builds

This directory contains the files necessary to perform bootstrappable franc
Core builds.
...
- 24GB of free disk space on the partition that the Franc git repository
  resides in
...
For a Franc depends development environment, simply invoke
...
From the top of a clean Franc repository:
...
To use dongcarl's substitute server for Franc builds after having

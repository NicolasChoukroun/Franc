...
The build system is set up to compile an executable called `test_franc`
...
For debugging you can launch the test_franc executable with `gdb`or `lldb` and
start debugging, just like you would with francd:

```bash
gdb src/test/test_franc
```

...
#ifndef FRANC_TEST_SCRIPTNUM10_H
#define FRANC_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Franc 0.10.0, for cross-comparison.
 */
public:

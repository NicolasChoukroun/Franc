...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_franc-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_franc-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_franc-qt  # macOS
void TestGUI()
{

...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatfrancURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + francUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatfrancURI(info));
}

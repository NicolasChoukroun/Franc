    ...
    mapper(nullptr)
{
    ...
    ui->francAtStartup->setToolTip(ui->francAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->francAtStartup->setText(ui->francAtStartup->text().arg(PACKAGE_NAME));

    ui->openfrancConfButton->setToolTip(ui->openfrancConfButton->toolTip().arg(PACKAGE_NAME));

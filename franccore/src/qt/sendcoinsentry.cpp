    ...
    platformStyle(_platformStyle)
{
    ...
    // normal franc address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying franc address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &francAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);

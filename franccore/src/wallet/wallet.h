...
#ifndef FRANC_WALLET_WALLET_H
#define FRANC_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! franc from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Franc wallet was originally a collection of unrelated private
...
public:
     ...
     * on this franc node, and set to 0 for transactions that were created

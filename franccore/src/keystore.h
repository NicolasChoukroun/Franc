...
#ifndef FRANC_KEYSTORE_H
#define FRANC_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/franc/bips/blob/master/bip-0013.mediawiki

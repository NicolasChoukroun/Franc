...
#ifndef FRANC_CRYPTO_CHACHA_POLY_AEAD_H
#define FRANC_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@franc.
 *
 ...
 *
 * The chacha20-poly1305@franc combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@franc cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@franc are relatively fast in
...
#endif // FRANC_CRYPTO_CHACHA_POLY_AEAD_H

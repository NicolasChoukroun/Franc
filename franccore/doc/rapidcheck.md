# RapidCheck property-based testing for Franc

## Concept

Property-based testing is experimentally being added to Franc with
...
If RapidCheck is installed, Franc will automatically run the
...
3. Configure Franc with RapidCheck.

    `cd` to the directory of your local franc repository and run
...
4. Build Franc with RapidCheck.
    ...
    Making all in src
    [...]
    CXX      test/gen/test_franc-crypto_gen.o
    CXX      test/test_franc-key_properties.o
    ```
...
That's it! You are now running property-based tests in Franc.

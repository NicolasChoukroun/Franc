Franc version 0.16.3 is now available from:

  <https://franccore.org/bin/franc-core-0.16.3/>
...
been discovered in Franc versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` francconsensus: invalid flags error should be set to `francconsensus_err` (afk11)

franc-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/franc/files/franc/franc-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the franc
...
New/changed settings (command-line or franc.conf file)
--------------------------------------------------------

Franc version 0.9.2.1 is now available from:

  https://franc.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 franc to 0.01 franc
...
- Fix "Start franc on system login"

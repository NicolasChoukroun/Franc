Franc version 0.13.2 is now available from:

  <https://franc.org/bin/franc-core-0.13.2/>
...
- #8908 `4a974b2` Update franc-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow franc-tx to create v2 transactions (btcdrak)

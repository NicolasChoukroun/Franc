Franc version 0.16.1 is now available from:

  <https://franccore.org/bin/franc-core-0.16.1/>
...
- #12843 `df38b13` Test starting francd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure francd processes are cleaned up when tests end (sdaftuar)

franc version 0.5.4 is now available for download at:
http://sourceforge.net/projects/franc/files/franc/franc-0.5.4/
...
http://gitorious.org/franc/francd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix franc-Qt notifications under Growl 1.3.
Increase required age of franc-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxfranc properly when installing franc-Qt over it. (Windows)

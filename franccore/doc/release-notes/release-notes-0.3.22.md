Download URL: https://sourceforge.net/projects/franc/files/franc/franc-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 franc fee schedule (users still pay 0.01 franc per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #franc00 - #franc99

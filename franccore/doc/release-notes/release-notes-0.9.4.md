Franc version 0.9.4 is now available from:

  https://franc.org/bin/0.9.4/
...
this update is incompatible with the franc system and could lead to consensus
forks.

Franc released binaries from https://franc.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~franc/+archive/ubuntu/franc
- A third-party or self-compiled Franc

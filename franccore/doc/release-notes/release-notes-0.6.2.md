franc version 0.6.2 is now available for download at:
http://sourceforge.net/projects/franc/files/franc/franc-0.6.2/
...
Fixed https://github.com/franc/franc/issues/1065, a bug that

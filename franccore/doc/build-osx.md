...
## `disable-wallet` mode
When the intention is to run only a P2P node without a wallet, Franc may be
...
The first time you run francd, it will start downloading the blockchain. This process could

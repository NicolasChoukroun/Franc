...
franc user and group. It is advised for security reasons to make the
configuration file and data directory only readable by the franc user and
group. Access to franc-cli and other francd rpc clients can then be
